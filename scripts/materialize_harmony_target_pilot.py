...
try:
    ...
    from scripts.harmony_chroma import PITCH_CLASSES, extract_cqt_chroma, extract_hpcp
except ModuleNotFoundError:  # Direct execution adds scripts/, not the repository root.
    from decide_harmony_extractor import decide as decide_extractor
    from harmony_chroma import PITCH_CLASSES, extract_cqt_chroma, extract_hpcp
