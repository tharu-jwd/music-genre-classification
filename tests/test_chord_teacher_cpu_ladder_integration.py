...
from scripts.decide_chord_teacher import decide, policy_template_for_source
from scripts.evaluate_chord_teacher import evaluate_manifest
from scripts.generate_essentia_chord_estimates import TEACHER_NAME, generate
